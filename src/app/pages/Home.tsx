...
const projects = [
  ...
  },
  {
    ...
    description: "An AI-powered collaborative text editor that helps students synthesize research papers. Features real-time collaboration using WebSockets and automated citation generation.",
  },
  {
    id: "chronos",
    ...
    image: "https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBpbnRlcmZhY2UlMjBkYXJrJTIwZWxlZ2FudCUyMG1vY2t1cHxlbnwxfHx8fDE3ODE3MjQ4ODl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["React Native", "Zustand", "SQLite", "Tailwind"],
    description: "A beautifully designed, offline-first task management application focused on keyboard-driven workflows and minimal friction. Featured on Product Hunt.",
  },
];
