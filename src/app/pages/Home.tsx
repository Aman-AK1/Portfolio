        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-8 flex flex-col items-center md:items-start text-center md:text-left space-y-8">
            ...
            >
              ...
              <a href="/Aman_Resume_Portfolio.pdf" download className="justify-center w-full md:w-auto px-4 md:px-6 py-3 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-all flex items-center gap-2 font-medium text-white text-sm md:text-base">
